...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        tf_matrices = robot.t_matrices
        robot.broadcast_tf(tf_matrices[8], 'tf_flange')
        robot.broadcast_tf(tf_matrices[9], 'tf_camera')
        robot.broadcast_tf(tf_matrices[10], 'tf_needle')
        r.sleep()
