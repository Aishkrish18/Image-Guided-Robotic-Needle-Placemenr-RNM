...
#   Calibrating both rgb and IR images to use their intrinsic matrices for Stereocalibration
...
cv.destroyAllWindows()
# Stereocalibrating rgb camera with ir camera to get the rgb to IR transformation.
